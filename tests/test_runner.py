...
Validates registration and executes direct test calls for EVERY registered tool in MacSystem-Mcp with timeout protection.
"""
...
async def run_all_tool_tests():
    print("==================================================")
    print("    COMPREHENSIVE ALL-TOOL TEST SUITE (87 TOOLS)  ")
    print("==================================================")
